...
export function LegalSection({
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <div className="flex flex-col gap-3 text-sm leading-relaxed text-muted-foreground [&_a]:text-brand-emphasis [&_a]:underline [&_a]:decoration-brand/45 [&_a]:underline-offset-4 [&_li]:leading-relaxed [&_ul]:flex [&_ul]:list-disc [&_ul]:flex-col [&_ul]:gap-2 [&_ul]:pl-5">
        {children}
      </div>
    </section>
  );
